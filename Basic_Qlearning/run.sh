...
python3 mountain_solver.py --lr 0.00025 --lr_decay 0 --eps 0.0 --eps_decay 0.0001  --n_eps 5000  --freeze_time 1000 --stime 10 --gamma 0.99 --load_path ./leakyRelu_2 --test --save_path ./visualize
